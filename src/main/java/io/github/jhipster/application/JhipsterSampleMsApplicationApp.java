...
public class JhipsterSampleMsApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSampleMsApplicationApp.class);

    private final Environment env;

    public JhipsterSampleMsApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSampleMSApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSampleMsApplicationApp.class);
